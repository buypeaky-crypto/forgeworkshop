...
import { a as formatDate, i as formatCount, n as cn, t as Shell } from "./shell-B8c1-bKl.mjs";
import { a as Pin, c as Download, o as Heart, r as Search, s as ExternalLink, t as X } from "../_libs/lucide-react.mjs";
import { h as TASKS, m as useBay, o as ModelCard, r as Route$1 } from "./router-Cjr9X_Y2.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/huggingface-NdN4Ew7X.js
...
function HuggingFacePage() {
	const { q, task, model } = Route$1.useSearch();
	const navigate = Route$1.useNavigate();
	const { models, selected } = Route$1.useLoaderData();
